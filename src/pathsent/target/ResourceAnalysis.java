...
import pathsent.PathSentStaticAnalysis;
...
public class ResourceAnalysis {
    ...
    public ResourceAnalysis(String apkPath) throws IOException {
        ...
        if (!PathSentStaticAnalysis.Config.PrintSootOutput) {
        ...
        try {
            ...
            _resourceParser.parse(new File(PathSentStaticAnalysis.Config.ApkFile));
        } finally {
