...
public class   Z3ConstraintGenerator{
    ...
    public Z3ConstraintGenerator(Predicate constraint) {
        Output.debug("Z3ConstraintGenerator: " + constraint.toString() + " (" + constraint.getClass() + ")");
    ...
    private String getNewZ3VariableName() {
        return "variable" + (_nextVariableNum++);
    }
    ...
    private String generateZ3Constraint(Predicate constraint) {
        ...
        Output.debug("generateZ3Constraint: " + constraint.toString() + " (" + constraint.getClass() + ")");
    ...
    private String generateZ3Expression(Expression expr) {
        ...
        Output.debug("generateZ3Expression: " + expr.toString() + " (" + expr.getClass() + ")");
        ...
        if (expr.isVariable()) {
            ...
            else if(stringExpr.getOperator().equals(Expression.Operator.STR_EQ)){
                z3Expression.append("(");
                z3Expression.append(generateZ3Expression(stringExpr.getLeft()));
                z3Expression.append(" == ");
                z3Expression.append(generateZ3Expression(stringExpr.getRight()));
